...
![Button Behavior](images/Button_Behavior.png)
...
There are a few additional *Hard-Coded Actions* that involve *Covering Certain Tone Holes* while clicking *WARBL2 Button 1*. 
...
* Covering only *Tone Hole R3* while pressing *WARBL2 Button 1* will change the *Instrument*.
		...
		Note that the Use "secret" button commands switch does not have to be on to use the "secret" drone control button, if that option is selected in the Drones Control panel.
